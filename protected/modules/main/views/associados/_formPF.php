<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#TbAssociado_nomefantasia").keyup(function() {
            $("#TbAssociado_nomefantasia").val($("#TbAssociado_nomefantasia").val().toUpperCase());
        });
        ...
        // Validation            
        $("#clientepf-form").validate({
            // Rules for form validation
            rules: {
                'TbAssociado[nomefantasia]': {
                    required: true,
                    minlength: 3,
                    maxlength: 255
                },
                ...
                'TbAssociado[idestado]': {
                    required: true
                },
                'TbAssociado[idcidade]': {
                    required: true,
                },
                'TbAssociado[email]': {
                    required: true,
            ...
            submitHandler: function(form) {
                ...
                var nome = $("#TbAssociado_nomefantasia").val();
                ...
                var url = "";
                if ("<?= $page; ?>" == 'create') {
                    url = "<?= Yii::app()->createAbsoluteUrl('/main/associados/createpf/') ?>";
                } else {
                    url = document.URL;
                }

                $.post(url, {nome: nome, documento: documento, estado: estado, cidade: cidade, bairro: bairro,
                    cep: cep, logradouro: logradouro, numero: numero, complemento: complemento, email: email,
                    home: home, fones: fones, operadoras: operadoras}, function(data) {
        ...
        $("#TbAssociado_documento").mask("999.999.999-99");
    });
</script>
<!-- RIBBON -->
<div id="ribbon">
                    ...
                    <fieldset id="itens">
                        <div class="row">
                            <section class="col col-lg-4">
                                <label class="label"><?php echo $form->labelEx($model, 'nomefantasia'); ?></label>
                                <label class="input"> <i class="icon-append fa  fa-briefcase"></i>
                                    <?php echo $form->textField($model, 'nomefantasia', array('size' => 60, 'maxlength' => 100)); ?>                                                                        
                                </label>
                            </section>   
                            <section class="col col-lg-4">
                        ...
                        <div class="row">
                            ...
                            <section class="col col-lg-4">
                                ...
                                <div class="input-group">
                                    ...
                                    ?>
                                    <?php echo $form->dropDownList($model, 'idcidade', $list, array('class' => 'select2 ddlcidade'), array('empty' => '-- Escolha um estado --')); ?>                                     
