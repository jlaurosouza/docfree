...
<html lang="en-us">
    ...
    <body id="login" class="animated fadeInDown">
        ...
        <header id="header">
            ...
            <div id="logo-group">
                <!--<span id="logo"> <img src="<--?php echo Yii::app()->request->baseUrl; ?>/assets/img/logo.png" alt="Docfree" style="width: 170%"> </span>-->
                <!-- END AJAX-DROPDOWN -->
            </div>            
            <!--
        ...
        <div id="main" role="main">
           <!--<span><img src='<--?php echo Yii::app()->request->baseUrl; ?>/assets/img/logo.png'></span>-->
            <!-- MAIN CONTENT -->
